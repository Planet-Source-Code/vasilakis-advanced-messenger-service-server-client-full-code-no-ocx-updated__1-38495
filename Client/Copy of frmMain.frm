...
Begin VB.Form frmMain 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00D3D3C3&
   Caption         =   "OmniCom Messenger v1.0"
   ClientHeight    =   7545
   ClientLeft      =   60
   ClientTop       =   630
   ClientWidth     =   3570
   ...
   Begin VB.Timer tmrAnimOnline 
      ...
      Top             =   5880
   End
   Begin Threed.SSFrame frameUsers 
      Height          =   4215
      Left            =   0
      TabIndex        =   1
      Top             =   960
   ...
   Begin MSComctlLib.ImageList imgListToolBar 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":65EA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":723E
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":7E92
            Key             =   ""
         EndProperty
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":973A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":9CD4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":A26E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":A808
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin Threed.SSFrame frameToolBar 
      Height          =   870
      Left            =   0
      TabIndex        =   14
      Top             =   30
   ...
   Begin VB.Label lblEmail 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "w w w . o m n i c o m . g r"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   161
...
On Error Resume Next
            UnloadBanner
            wsockBanner.Close
            wsockBanner.Connect "liveupdate.omnicom.gr", 8990
End Sub
...
Sub UnloadBanner()
    ...
    URL = "http://liveupdate.omnicom.gr/omni_msg/"
    CenterBanners
End Sub
...
modIcon Me, IconObject.Handle, imgTrayOffLine.Picture, "OmniCom Messenger! - Offline"
...
lstWait.ListItems.Clear
Unload frmLogin
frmLogin.txtUSER.Text = GetSetting("OmniCom Messenger", "Login", "Email", "user@domain.com")

frmLogin.chkSavePassword.Value = GetSetting("OmniCom Messenger", "Login", "SavePass", "0")
If frmLogin.chkSavePassword.Value = 1 And ConnectCMD = False Then
    frmLogin.txtPASS.Text = GetSetting("OmniCom Messenger", "Login", "Password", "")
    'Visible = False
Else
    frmLogin.Show 1
End If
...
If rStatus = 0 Then
    ...
    modIcon Me, IconObject.Handle, imgTrayOnLine.Picture, "OmniCom Messenger! - Online"
    sbBar.SimpleText = "Online."
ElseIf rStatus = 1 Then
    mnuStatusAway.Checked = True
    modIcon Me, IconObject.Handle, imgList.ListImages(4).Picture, "OmniCom Messenger! - (Away)"
    sbBar.SimpleText = "Away..."
ElseIf rStatus = 2 Then
    mnuStatusBusy.Checked = True
    modIcon Me, IconObject.Handle, imgList.ListImages(4).Picture, "OmniCom Messenger! - (Busy)"
    sbBar.SimpleText = "Busy..."
ElseIf rStatus = 3 Then
    mnuStatusBRB.Checked = True
    modIcon Me, IconObject.Handle, imgList.ListImages(4).Picture, "OmniCom Messenger! - (Be Right Back)"
...
If rAutoCheckMail = "1" Then
    ...
    emailUsername = GetSetting("OmniCom Messenger", "Settings", "emailUsername")
    emailPassword = DecryptPassword(0.06, GetSetting("OmniCom Messenger", "Settings", "emailPassword"))
    emailPOPServer = GetSetting("OmniCom Messenger", "Settings", "emailPOPServer")
Else
...
AddIcon Me, IconObject.Handle, IconObject, "OmniCom Messenger!"
DoEvents
CloseConnection
...
Public Sub AddButton()
    'Add the command bar button "Send/Delete
    '     " to the inspector's toolbar
    ...
    If Not cbb Is Nothing Then
        ...
        Exit Sub
    End If
    'doesn't exist -> put it after the "S
    '     end" item (ID=2617)
...
Public Function GetEmail(Contact As ContactItem)
    'Extract the best email address which is
    '     resolves offline
...
On Error Resume Next
frmAbout.Show 1
'MsgBox "OmniCom Messenger v" & App.Major & "." & App.Minor & "." & App.Revision & ", created by OmniCom S.A." & _
 'vbCrLf & vbCrLf & "Contact ------------------------" & vbCrLf & _
 '"OmniCom S.A." & vbCrLf & vbCrLf & _
 '"ATHENS, Pl. Karysth 5, 10561" & _ vbcrlf
 '"LARISSA, Koyma 1, 41222" & vbCrLf & vbCrLf & "Tel: (+30) 41 537343" & vbCrLf & "Fax: (+30) 41 537343", vbInformation, "About OmniCom Messenger"
End Sub
...
On Error Resume Next
If wsock.State = sckConnected Then
    rYN = MsgBox("You are currently Connected. Are you sure you want to quit?", vbYesNo + vbQuestion, "Exit OmniCom Messenger!")
    If rYN = vbYes Then
        EndApp
    End If
Else
...
cmd:
    Select Case COMM
        ...
        Case "noauth"
            SaveSetting "OmniCom Messenger", "Login", "SavePass", "0"
            DeleteSetting "OmniCom Messenger", "Login", "Password"
        ...
        Case "login"
            ...
            SaveSetting "OmniCom Messenger", "Login", "Email", myEmail
            SaveSetting "OmniCom Messenger", "Login", "Password", frmLogin.txtPASS.Text
            SaveSetting "OmniCom Messenger", "Login", "SavePass", frmLogin.chkSavePassword.Value
            Unload frmLogin
        Case "yourinfo"
